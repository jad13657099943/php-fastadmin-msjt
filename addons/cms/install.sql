...
CREATE TABLE IF NOT EXISTS `__PREFIX__cms_addondownload` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='下载' ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='内容表' ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS `__PREFIX__cms_block` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='区块表' ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='栏目表' ROW_FORMAT=COMPACT;
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='评论表' ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS `__PREFIX__cms_diyform`(
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='自定义表单表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='模型字段表' ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS `__PREFIX__cms_message` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='站内留言';
...
CREATE TABLE IF NOT EXISTS `__PREFIX__cms_model` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='内容模型表' ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS `__PREFIX__cms_page` (
  ...
  PRIMARY KEY (`id`),
  KEY `type` (`type`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='单页表' ROW_FORMAT=COMPACT;
...
(9, '焦点图', 'sidebarad2', '边栏广告2', 'https://cdn.fastadmin.net/uploads/store/aliyun-sidebar.png', 'http://www.fastadmin.net', '<a href=\"https://promotion.aliyun.com/ntms/yunparter/invite.html?userCode=t50mdbun\" rel=\"nofollow\" title=\"FastAdmin推荐企业服务器\" target=\"_blank\">\r\n        <img src=\"https://cdn.fastadmin.net/uploads/store/aliyun-sidebar.png\" class=\"img-responsive\" alt=\"\">\r\n</a>', 1553606219, 1553958942, 'normal'),
...
(1, '新闻', 'cms_addonnews', 'author,price', 'channel_news.html', 'list_news.html', 'show_news.html', 1508990659, 1553759313, ''),
(2, '产品', 'cms_addonproduct', 'productdata', 'channel_product.html', 'list_product.html', 'show_product.html', 1508992445, 1508992445, ''),
(3, '下载', 'cms_addondownload', 'os,version,filesize,language,downloadurl,screenshots,price,downloads', 'channel_download.html', 'list_download.html', 'show_download.html', 1553507913, 1553744995, '');
...
--
BEGIN;
ALTER TABLE `__PREFIX__cms_archives` MODIFY COLUMN `flag` set('hot','new','recommend','top') CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '标志' AFTER `style`;
COMMIT;
...
--
BEGIN;
ALTER TABLE `__PREFIX__cms_message` ADD COLUMN `image` varchar(100) NULL DEFAULT '' COMMENT '图片' AFTER `content`;
COMMIT;