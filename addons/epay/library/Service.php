...
class Service
{
    ...
    public static function submitOrder($amount, $orderid = null, $type = null, $title = null, $notifyurl = null, $returnurl = null, $method = null, $refund = false, $refund_no = '')
    {
        if (!is_array($amount)) {
            $params = [
                'amount' => $amount,
...
//        $config[$type]['notify_url'] = $config[$type]['notify_url'];
        $config[$type]['return_url'] = $returnurl;
        $config[$type]['notify_url'] = $params['notifyurl'];
            ...
            switch ($method) {
                ...
                case 'app':
                    ...
                    if ($refund == false) {
                        ...
                        $html = $pay->driver($type)->gateway('app')->refund($params);
                    }
                ...
                case 'app':
                    ...
                    if ($refund == false) {
                        ...
                        $params = [
                            ...
                            'total_fee' => $amount * 100,//订单金额 必须是整数
                            'refund_fee' => $amount * 100,//退款金额 必须是整数
                        ];
                        $html = $pay->driver($type)->gateway('app')->refund($params);
                    }
                    break;
