            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover"
                           data-operate-edit="<?php echo $auth->check('apply/groupbuy/edit'); ?>"
                           data-operate-limit_discount_manage="<?php echo $auth->check('apply/Groupbuy/manage'); ?>"
                           data-operate-del="<?php echo $auth->check('apply/groupbuy/del'); ?>"
                           width="100%">
                    </table>
                </div>
            </div>
