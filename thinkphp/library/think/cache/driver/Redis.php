...
class Redis extends Driver
{
   ...
   public function lPush($key , $value){
    ...
    /*public  function getHandler($key){
        return $this->handler->sAdd();
    }*/

    public function hMSet($name , $key1 ,$value1,$key2 ,$value2,$key3 ,$value3){
        return $this->handler->hMSet($name,$key1 ,$value1,$key2 ,$value2,$key3 ,$value3);
    }
