...
class Course extends Model
{
    ...
    public function setCourseListAttr($value)
    {
        return serialize($value);
    }

    public function getCourseListAttr($value)
    {
  ...
  * */
    public function editGoodsPriceSction($goods_id, $spec_type)
    {
        ...
        switch ($spec_type) {
            case 10: //单规格
                $litestoregoodsspec = $model->getLitestoreGoodsSpecInfo($goods_id, 'goods_price,line_price,marketing_price');
