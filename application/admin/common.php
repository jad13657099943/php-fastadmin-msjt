...
if (!function_exists('build_toolbar')) {
    ...
    function build_toolbar($btns = NULL, $attr = [])
    {
        ...
        $btns = $btns ? $btns : ['refresh', 'add', 'edit', 'del', 'import', 'export'];
        ...
        $btnAttr = [
            ...
            'export' => ['javascript:;', 'btn btn-danger btn-import', 'fa fa-download', __('导出'), __('导出')],
        ];
   ...
   * */
    function getImgs($images)
    {
        ...
        if (strstr($string, $png[1])) {
            return ['video' => '', 'image' => $images[0]];
        } else {
            return ['video' => $images[0], 'image' => $images[0] . '?vframe/jpg/offset/1'];
        }
    }
}
