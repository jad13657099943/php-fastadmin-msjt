...
!function ($) {
    ...
    var createFormCommon = function (pColumns, that) {
        ...
        for (var i in pColumns) {
            ...
            if (!vObjCol.checkbox && vObjCol.field !== 'operate' && vObjCol.searchable && vObjCol.operate !== false) {
                ...
                htmlForm.push(sprintf('<label for="%s" class="control-label col-xs-3">%s</label>', vObjCol.field, vObjCol.title));
                htmlForm.push('<div class="col-xs-9">');
    ...
    var createFormBtn = function (that) {
        ...
        htmlBtn.push('<div class="col-sm-8 col-xs-offset-2">');
