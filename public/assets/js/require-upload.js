define(['jquery', 'bootstrap', 'plupload', 'template'], function ($, undefined, Plupload, Template) {
    var Upload = {
        ...
        config: {
            ...
            previewtpl: '<li class="col-xs-3"><a href="<%=url%>" data-url="<%=url%>" target="_blank" class="thumbnail"><img src="<%=url%>" class="img-responsive"></a><a href="javascript:;" class="btn btn-danger btn-xs btn-trash"><i class="fa fa-trash"></i></a></li>',
        },
        events: {
            //初始化完成
