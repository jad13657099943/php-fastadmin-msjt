define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'msjt/curriculum/type/index',
                    add_url: 'msjt/curriculum/type/add',
                    edit_url: 'msjt/curriculum/type/edit',
                    del_url: 'msjt/curriculum/type/del',
                    multi_url: 'msjt/curriculum/type/multi',
                    table: 'msjt_goods_curriculum_type',
                    dragsort_url: '',
                }
            });
