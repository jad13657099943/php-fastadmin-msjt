define(['jquery', 'bootstrap', 'backend', 'table', 'form','litestorefreight_delivery','litestorefreight_regionalChoice'], function ($, undefined, Backend, Table, Form,delivery,regionalChoice) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'litestore/litestorefreight/index',
                    add_url: 'litestore/litestorefreight/add',
                    edit_url: 'litestore/litestorefreight/edit',
                    del_url: 'litestore/litestorefreight/del',
                    multi_url: 'litestore/litestorefreight/multi',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'method', title: __('Method'), searchList: {"10":__('Method 10'),"20":__('Method 20'),"30":__('Method 30')}, formatter: Table.api.formatter.normal},
