define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'dansubject/dansubjectcategory/index',
                    add_url: 'dansubject/dansubjectcategory/add',
                    edit_url: 'dansubject/dansubjectcategory/edit',
                    del_url: 'dansubject/dansubjectcategory/del',
                    multi_url: 'dansubject/dansubjectcategory/multi',
